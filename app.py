...
#打包命令
#pyinstaller --noconfirm --clean --onefile --name AutoPlan_V7.5.8 -i "D:/Agilebot-Autoplan/static/favicon.ico" --add-data "templates;templates" --add-data "static;static" --add-data "config.json;." --collect-all numpy --collect-all matplotlib --hidden-import numpy._core._exceptions app.py
#安装依赖
